...
class StringLibrary:
    ...
    def get_question_words(self, question, ner=None, nlp=None):
        ...
        question_words = []
        # apply NER
        entity_spots = StringLibrary._apply_ner(question, ner, nlp)
    ...
    @staticmethod
    def _apply_ner(question, ner="tagme", nlp=None):
        """
    ...
    def is_entity(string):
        ...
        return ENT_PATTERN.match(string.strip()) is not None

    @staticmethod
    def is_date(string):
        """Return if the given string is a date."""
        return DATE_PATTERN.match(string.strip()) is not None
    ...
    def is_mdy_date(string):
        ...
        mdy format: https://en.wikipedia.org/wiki/Template:Use_mdy_dates
        """
        return DATE_PATTERN_MDY.match(string.strip()) is not None

    @staticmethod
    def is_year(string):
        """Return if the given string describes a year in the format YYYY."""
        return YEAR_PATTERN.match(string.strip()) is not None
    ...
    def is_number(string):
        ...
        string = string.strip()
        return NUMBER_PATTERN.match(string.strip()) is not None
